...
test('next-event hero keeps the countdown and both stream QR codes above supporting content', () => {
  ...
  assert.ok(qrGridIndex > countdownIndex, 'Expected the QR grid inside the countdown hero.');
  assert.ok(
